# ODV-Updatefunktion ab v72 – Ablauf für Superadmins
...
```powershell
Get-FileHash "C:\Nextcloud_OC\02_AUSTAUSCH\ODV_UPDATE\Windows\ODV_v72.zip" -Algorithm SHA256
```
...
- freigegebene Version, z. B. `v72`
- Dateiname, z. B. `ODV_v72.zip`
...
Wenn die App nach dem Update z. B. v72 meldet, die API aber v71, muss zusätzlich `server/routes_v72.php` als `ortschronik-api/routes.php` hochgeladen werden.
