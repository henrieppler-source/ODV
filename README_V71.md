# ODV v71 – Komfort-Updater über Nextcloud
...
`server/routes_v71.php` wie gewohnt als `ortschronik-api/routes.php` hochladen.


## Buildfix 3

- Komfort-Updater beendet die alte ODV nun hart nach dem Start des Updaters, damit Dateien nicht gesperrt bleiben.
- Die neu gestartete ODV bekommt einmalig `--odv-skip-update-check-once`, damit nach dem Update keine sofortige Update-Endlosschleife entsteht.
- Der Updater schreibt `last_update_result.json` unter `%LOCALAPPDATA%\ODV\updates`.
